...
export function BolterMenu({ bolterData, onStartGame }: BolterMenuProps) {
  ...
  // Smooth mouse following with much slower response
  useEffect(() => {
    const smoothFollow = () => {
      setSmoothMousePosition(prev => ({
        x: prev.x + (mousePosition.x - prev.x) * 0.02, // Much slower: 2% per frame
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute w-96 h-96 bg-gradient-radial from-purple-500/10 to-transparent rounded-full pointer-events-none"
          style={{
            left: smoothMousePosition.x - 192,
            top: smoothMousePosition.y - 192,
          }}
        />
      </div>

      <div className="relative z-10 flex items-center justify-center min-h-screen p-2">
        <div className="bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 max-w-5xl w-full border border-purple-500/30 relative overflow-hidden">
          {/* Card glow effect */}
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              <div className="relative">
                <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 mb-3 animate-pulse drop-shadow-2xl">
                  ⚔️ Wrath of the Wrappers
                </h1>
                <div className="absolute inset-0 text-4xl md:text-5xl font-bold text-purple-400/20 blur-sm animate-pulse">
                  ⚔️ Wrath of the Wrappers
                </div>
              </div>
              <p className="text-gray-300 text-lg font-medium animate-fade-in">Master the art of the Bolter</p>
              
              {/* Subtitle with typing effect */}
              <div className="mt-3 text-purple-300 text-base font-light animate-pulse">
                Survive • Upgrade • Dominate
              </div>
            </div>

            {/* Bolter Class Card */}
            <div className="bg-gradient-to-br from-gray-700/50 to-gray-800/50 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-purple-400/30 relative overflow-hidden group hover:border-purple-400/60 transition-all duration-500">
              {/* Card hover effect */}
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-base">{bolterConfig.description}</p>
                  </div>
                </div>

                {/* Stats Grid */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                  <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-3 border border-yellow-500/30 group-hover:border-yellow-500/60 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-3 border border-green-500/30 group-hover:border-green-500/60 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-3 border border-red-500/30 group-hover:border-red-500/60 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-3 border border-blue-500/30 group-hover:border-blue-500/60 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                ...
                {/* Upgrades Section */}
                <div className="bg-gray-600/40 backdrop-blur-sm rounded-xl p-4 border border-purple-400/20">
                  <div className="flex items-center gap-2 mb-4">
                    <Crown className="w-6 h-6 text-purple-400" />
                    <div className="text-base font-bold text-white">Permanent Upgrades</div>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    <div className="flex flex-col items-center p-3 bg-gray-700/50 rounded-lg border border-red-500/30 hover:border-red-500/60 transition-all duration-300 hover:scale-105">
                      ...
                      <span className="text-white font-bold text-base">{bolterData.permanentUpgrades.damage}</span>
                    </div>
                    <div className="flex flex-col items-center p-3 bg-gray-700/50 rounded-lg border border-green-500/30 hover:border-green-500/60 transition-all duration-300 hover:scale-105">
                      ...
                      <span className="text-white font-bold text-base">{bolterData.permanentUpgrades.speed}</span>
                    </div>
                    <div className="flex flex-col items-center p-3 bg-gray-700/50 rounded-lg border border-pink-500/30 hover:border-pink-500/60 transition-all duration-300 hover:scale-105">
                      ...
                      <span className="text-white font-bold text-base">{bolterData.permanentUpgrades.health}</span>
                    </div>
                    <div className="flex flex-col items-center p-3 bg-gray-700/50 rounded-lg border border-orange-500/30 hover:border-orange-500/60 transition-all duration-300 hover:scale-105">
                      ...
                      <span className="text-white font-bold text-base">{bolterData.permanentUpgrades.fireRate}</span>
                    </div>
                    <div className="flex flex-col items-center p-3 bg-gray-700/50 rounded-lg border border-yellow-500/30 hover:border-yellow-500/60 transition-all duration-300 hover:scale-105">
                      ...
                      <span className="text-white font-bold text-base">{bolterData.permanentUpgrades.goldBonus}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center">
              <button
                ...
                className="group relative px-10 py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-500 hover:via-pink-500 hover:to-blue-500 text-white rounded-2xl font-bold text-xl transition-all duration-500 transform hover:scale-110 hover:shadow-2xl overflow-hidden"
              >
                {/* Button glow effect */}
              ...
              {/* Button subtitle */}
              <p className="mt-3 text-gray-400 text-base animate-pulse">
